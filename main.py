...
"""Импортирует функцию случайного целого числа."""

from graphic_arts.start_game_banner import run_screensaver

"""Импортирует функцию графической заставки."""


def attack(char_name: str, char_class: str) -> str:
    """Рассчитывает урон персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчитывает блокированный урон."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Рассчитывает применение специальных умений."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Знакомит с навыками персонажей."""
    if char_class == 'warrior':
